...
dataset = pd.read_csv('../document/AnnualReports1618.csv')
dataset_2016 = dataset[dataset['filed_date'] < 20170000]

position = []
for document in dataset_2016['item7']:
...
dataset_2016.to_csv('../document/AnnualReports16_position.csv', index=False)
